...
<div class="container p-4">
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            <label for="exampleFile2" class="form-label">ファイル添付2:</label>
            <input type="file" class="form-control" id="exampleFile2" name="fileAttach2">
            <span class="error" style="color:red"><?= $errors['fileAttach2'] ?? '' ?></span>
        </div>
        <div class="mb-3">
